...
{#if open}
  ...
  >
    <div class="modal-content" on:click|stopPropagation on:keydown|stopPropagation>
      ...
      <p class="subtitle">
        You just made a payment to <strong>{paymentSourceName}</strong>. Would you like to update
        the balance?
      </p>
      ...
      <div class="balance-summary">
        ...
        <div class="balance-row total">
          ...
          <span
            class="value"
            class:debt={newBalance > 0}
            class:zero={newBalance === 0}
            class:credit={newBalance < 0}
          >
      ...
      <div class="actions">
        <button class="btn skip" on:click={handleSkip} disabled={saving}> Skip </button>
