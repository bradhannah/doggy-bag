<script lang="ts">
  ...
  $: visibleGroups = incomesByCategory.filter((group) => {
            ...
            <div class="col-name">
              <span class="income-name">
                ...
                {#if income.payment_method}
                  <span class="payment-method-pill" class:auto={income.payment_method === 'auto'}>
                    {income.payment_method === 'auto' ? 'Auto' : 'Manual'}
                  </span>
                {/if}
              </span>
