...
const sampleDetailedMonthData: DetailedMonthData = {
  ...
  tallies: {
    ...
    insuranceExpenses: { expected: 0, actual: 0, remaining: 0 },
    ...
    insuranceReimbursements: { expected: 0, actual: 0, remaining: 0 },
  ...
  overdue_bills: [],
  payoffSummaries: [],
  insuranceExpenseSection: null,
  insuranceReimbursementSection: null,
  bankBalances: {},
